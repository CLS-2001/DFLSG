...
def get_args():
    parser = argparse.ArgumentParser(description="DFLSG Args")
    ######################## general settings ########################
    ...
    parser.add_argument("--text_aug", default=True, action='store_true', help="whether to use Mask Language Modeling dataset")
    ...
    ######################## dataset ########################
    parser.add_argument("--target_dataset_name", default="ICFG-PEDES", help="[CUHK-PEDES, ICFG-PEDES, RSTPReid]")
    parser.add_argument("--memory_update", type=float, default=0.1,
                        help="update momentum for the hybrid memory")

    parser.add_argument("--beta", type=float, default=2.0)
    #parser.add_argument("--sampler", default="random", help="choose sampler from [idtentity, random]")
    parser.add_argument("--num_instance", type=int, default=8)
    parser.add_argument("--root_dir", default="/home/yangxiaohui/SCL/datasets/")
