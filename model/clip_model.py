...
logger = logging.getLogger("DFLSG.model")
...
def build_CLIP_from_openai_pretrained(name: str, image_size: Union[int, Tuple[int, int]], stride_size: int, jit: bool = False, download_root: str = '/home/yangxiaohui/SCL/datasets/backbone/clip'):
    """Load a CLIP model
